...
const questionsDB = {
    ...
    ds: [
        // ========== Revision 1 - MCQ ==========
        { type: "mcq", question: "What is a distributed system?", options: ["A single computer system", "A system with a global clock", "A system that does not allow communication between nodes", "A collection of autonomous computing elements that appear as a single coherent system"], answer: 3, explanation: "النظام الموزع مجموعة أجهزة مستقلة بتظهر للمستخدم كنظام واحد متماسك." },
        { type: "mcq", question: "Each computer in a distributed system is called:", options: ["Process", "Node", "Thread", "Server"], answer: 1, explanation: "كل جهاز كمبيوتر في النظام الموزع اسمه Node." },
        { type: "mcq", question: "What does 'autonomous nodes' mean?", options: ["Nodes depend on a central controller", "Nodes share memory", "Nodes operate independently", "Nodes have identical clocks"], answer: 2, explanation: "Autonomous يعني إن كل Node بيشتغل بشكل مستقل عن الباقي." },
        { type: "mcq", question: "Why is synchronization difficult in distributed systems?", options: ["Nodes share the same clock", "There is no global clock", "Memory is shared", "Nodes are centrally controlled"], answer: 1, explanation: "مفيش ساعة عالمية واحدة، كل Node عنده ساعته الخاصة." },
        { type: "mcq", question: "What is an overlay network in a distributed system?", options: ["A physical network", "A virtual or logical network created on top of an existing physical network", "A network with no communication paths", "A network with a single node"], answer: 1, explanation: "Overlay network شبكة افتراضية أو منطقية بتتبني فوق الشبكة الفيزيائية." },
        { type: "mcq", question: "In distributed systems, partial failure means:", options: ["The whole system stops", "Only one node can fail at a time", "Some components fail while others continue working", "Failures never occur"], answer: 2, explanation: "Partial failure يعني بعض الأجزاء بتفشل والباقي بيكمل شغل." },
        { type: "mcq", question: "In banking systems, which property is most critical?", options: ["Performance", "Entertainment", "Consistency", "Scalability"], answer: 2, explanation: "البنوك محتاجة Consistency علشان البيانات تكون صحيحة دايمًا." },
        { type: "mcq", question: "Which system has no global clock?", options: ["Parallel system", "Distributed system", "Centralized system", "Standalone system"], answer: 1, explanation: "الأنظمة الموزعة مفيهاش ساعة عالمية واحدة." },
        { type: "mcq", question: "Which is NOT a challenge in distributed systems?", options: ["Network latency", "Data consistency", "Security", "Single global clock"], answer: 3, explanation: "Single global clock مش تحدي لأنه أصلاً مش موجود في الأنظمة الموزعة." },
        { type: "mcq", question: "What is an open group in a distributed system?", options: ["A group where only specific nodes can join", "A group with no communication", "A group where any node is allowed to join and communicate", "A group with a single node"], answer: 2, explanation: "Open group أي Node يقدر ينضم ويتواصل." },
        { type: "mcq", question: "What is middleware in a distributed system?", options: ["A hardware component", "A software layer between applications and the underlying operating systems", "A local operating system", "A network cable"], answer: 1, explanation: "Middleware طبقة برمجية بين التطبيقات وأنظمة التشغيل." },
        { type: "mcq", question: "What is the purpose of middleware in distributed systems?", options: ["Replace the operating system", "Abstract complex interactions and hide infrastructure details", "Increase hardware complexity", "Remove network communication"], answer: 1, explanation: "Middleware بيخفي التعقيدات ويبسط التفاعل بين المكونات." },
        { type: "mcq", question: "What is the main goal of resource sharing in distributed systems?", options: ["Limit access to resources", "Facilitate users' access to remote resources", "Increase network latency", "Reduce collaboration"], answer: 1, explanation: "الهدف تسهيل وصول المستخدمين للموارد البعيدة." },
        { type: "mcq", question: "What does openness in distributed systems mean?", options: ["The ability to extend and improve the system by adding hardware or software components", "Limiting the number of users", "Reducing scalability", "Using a single operating system"], answer: 0, explanation: "Openness يعني إمكانية التوسيع والتحسين بإضافة مكونات." },
        { type: "mcq", question: "Which scalability dimension refers to handling more users or processes?", options: ["Administrative scalability", "Geographical scalability", "Size scalability", "Hardware scalability"], answer: 2, explanation: "Size scalability = التعامل مع عدد أكبر من المستخدمين أو العمليات." },
        { type: "mcq", question: "Which architecture uses centralized resources but may create a scalability bottleneck?", options: ["Client-Server architecture", "Peer-to-Peer architecture", "Distributed file system", "Virtualization"], answer: 0, explanation: "Client-Server مركزي وممكن يكون bottleneck في التوسع." },
        { type: "mcq", question: "Which architecture has no central point of failure and is highly scalable?", options: ["Client-Server", "Peer-to-Peer (P2P)", "Database system", "Local system"], answer: 1, explanation: "P2P مفيش نقطة فشل مركزية وقابل للتوسع." },
        { type: "mcq", question: "Which architecture provides decentralized resource sharing?", options: ["Client-Server", "Peer-to-Peer (P2P)", "Standalone system", "Local storage"], answer: 1, explanation: "P2P بيوفر مشاركة موارد لامركزية." },

        // Transparency
        { type: "mcq", question: "What does distribution transparency hide from users?", options: ["System complexities and internal details", "Hardware failures", "Operating systems", "Network cables"], answer: 0, explanation: "Distribution transparency بتخفي التعقيدات والتفاصيل الداخلية." },
        { type: "mcq", question: "Which transparency hides where an object is located?", options: ["Access transparency", "Location transparency", "Replication transparency", "Concurrency transparency"], answer: 1, explanation: "Location transparency بتخفي مكان وجود الكائن." },
        { type: "mcq", question: "Which transparency hides how an object is accessed?", options: ["Access", "Location", "Migration", "Failure"], answer: 0, explanation: "Access transparency بتخفي طريقة الوصول للكائن." },
        { type: "mcq", question: "Which transparency hides that an object may move to another location while in use?", options: ["Migration transparency", "Relocation transparency", "Access transparency", "Failure transparency"], answer: 0, explanation: "Migration transparency بتخفي انتقال الكائن أثناء الاستخدام." },
        { type: "mcq", question: "Which transparency hides that an object is replicated across multiple servers?", options: ["Replication transparency", "Location transparency", "Migration transparency", "Access transparency"], answer: 0, explanation: "Replication transparency بتخفي إن الكائن متكرر على سيرفرات متعددة." },
        { type: "mcq", question: "Which transparency hides failures and recovery mechanisms from users?", options: ["Replication transparency", "Failure transparency", "Concurrency transparency", "Migration transparency"], answer: 1, explanation: "Failure transparency بتخفي الأعطال وآليات الاسترداد." },
        { type: "mcq", question: "Which of the following is a challenge in achieving full distribution transparency?", options: ["Latency cannot be hidden", "Transparency improves performance", "Replicas are always synchronized", "Failures are easy to detect"], answer: 0, explanation: "Latency (التأخير) صعب إخفاؤه وده من التحديات الرئيسية." },

        // Cloud Computing
        { type: "mcq", question: "What is utility computing?", options: ["Computing resources provided as a public utility where users pay only for usage", "Computing resources stored locally", "Fixed-rate computing resources", "Hardware-only infrastructure"], answer: 0, explanation: "Utility computing = موارد حوسبة كخدمة عامة، المستخدم بيدفع حسب الاستخدام." },
        { type: "mcq", question: "What is grid computing primarily designed for?", options: ["Enterprise resource management", "Scientific computing problems", "Gaming systems", "Local networks"], answer: 1, explanation: "Grid computing مصمم أساسًا لمسائل الحوسبة العلمية." },
        { type: "mcq", question: "IaaS provides:", options: ["Applications", "Development tools", "Virtual machines", "Storage only"], answer: 2, explanation: "IaaS بيوفر موارد حوسبة افتراضية زي Virtual Machines." },
        { type: "mcq", question: "PaaS provides:", options: ["Infrastructure", "Platform and tools", "Applications", "Hardware"], answer: 1, explanation: "PaaS بيوفر منصة وأدوات للتطوير." },
        { type: "mcq", question: "SaaS provides:", options: ["Virtual machines", "Software applications", "Network devices", "Databases"], answer: 1, explanation: "SaaS بيوفر تطبيقات برمجية جاهزة عبر الإنترنت." },
        { type: "mcq", question: "Which is an example of IaaS?", options: ["Google Workspace", "Amazon EC2", "Dropbox", "Microsoft 365"], answer: 1, explanation: "Amazon EC2 مثال على IaaS لأنه بيوفر VMs." },
        { type: "mcq", question: "Which is an example of PaaS?", options: ["Google App Engine", "Gmail", "Dropbox", "Microsoft 365"], answer: 0, explanation: "Google App Engine منصة تطوير = PaaS." },
        { type: "mcq", question: "Which is an example of SaaS?", options: ["Google Compute Engine", "Microsoft Azure VMs", "Google Workspace (Gmail, Drive)", "Heroku"], answer: 2, explanation: "Google Workspace تطبيقات جاهزة = SaaS." },
        { type: "mcq", question: "Which cloud deployment model is provided by external providers and shared by multiple users?", options: ["Public Cloud", "Private Cloud", "Hybrid Cloud", "Community Cloud"], answer: 0, explanation: "Public Cloud مشترك بين عدة مستخدمين ومقدم من مزود خارجي." },
        { type: "mcq", question: "Which cloud deployment model is used by a single organization only?", options: ["Public Cloud", "Private Cloud", "Hybrid Cloud", "Community Cloud"], answer: 1, explanation: "Private Cloud لمنظمة واحدة فقط." },
        { type: "mcq", question: "Which cloud deployment model combines public and private clouds?", options: ["Public Cloud", "Private Cloud", "Hybrid Cloud", "Community Cloud"], answer: 2, explanation: "Hybrid Cloud بيجمع بين Public و Private." },
        { type: "mcq", question: "Which cloud deployment model is shared by organizations with similar needs?", options: ["Public Cloud", "Private Cloud", "Hybrid Cloud", "Community Cloud"], answer: 3, explanation: "Community Cloud مشترك بين منظمات لها احتياجات متشابهة." },
        { type: "mcq", question: "Which cloud characteristic allows users to create computing resources automatically anytime?", options: ["Broad Network Access", "On-Demand Service", "Resource Pooling", "Rapid Elasticity"], answer: 1, explanation: "On-Demand Service = إنشاء موارد تلقائيًا في أي وقت." },
        { type: "mcq", question: "Which characteristic allows resources to scale up or down dynamically?", options: ["Measured Service", "Resource Pooling", "Rapid Elasticity", "Broad Network Access"], answer: 2, explanation: "Rapid Elasticity = التوسع والانكماش ديناميكيًا حسب الطلب." },
        { type: "mcq", question: "Which characteristic allows cloud services to be accessed from any device over the internet?", options: ["On-Demand Service", "Broad Network Access", "Resource Pooling", "Measured Service"], answer: 1, explanation: "Broad Network Access = الوصول من أي جهاز عبر الإنترنت." },
        { type: "mcq", question: "Which cloud characteristic means usage is monitored and billed based on consumption?", options: ["Rapid Elasticity", "Resource Pooling", "Measured Service", "Broad Network Access"], answer: 2, explanation: "Measured Service = المراقبة والمحاسبة حسب الاستهلاك." },
        { type: "mcq", question: "Which cloud characteristic means resources are shared between many users?", options: ["Rapid Elasticity", "Resource Pooling", "Measured Service", "On-Demand Service"], answer: 1, explanation: "Resource Pooling = الموارد مشتركة بين عدة مستخدمين." },

        // Virtualization
        { type: "mcq", question: "Which of the following is TRUE about distributed systems?", options: ["Use shared memory", "Have a global clock", "Nodes are independent", "No communication"], answer: 2, explanation: "في الأنظمة الموزعة الـ Nodes مستقلة." },
        { type: "mcq", question: "Which middleware type ensures data consistency in distributed transactions?", options: ["Communication middleware", "Transaction middleware", "Application middleware", "Database middleware"], answer: 1, explanation: "Transaction middleware بيضمن تناسق البيانات في المعاملات الموزعة." },
        { type: "mcq", question: "Which middleware type facilitates data exchange between distributed components?", options: ["Communication middleware", "Transaction middleware", "Database middleware", "Application middleware"], answer: 0, explanation: "Communication middleware بيسهل تبادل البيانات." },
        { type: "mcq", question: "Which system has no single point of failure?", options: ["Client-Server", "Peer-to-Peer", "Centralized", "Standalone"], answer: 1, explanation: "P2P مفيش نقطة فشل واحدة." },
        { type: "mcq", question: "What technology creates virtual machines?", options: ["Virtualization", "Grid Computing", "Replication", "Resource Pooling"], answer: 0, explanation: "Virtualization هي التقنية لإنشاء VMs." },
        { type: "mcq", question: "Which software manages multiple virtual machines on one physical server?", options: ["Hypervisor", "VLAN", "NAS", "SAN"], answer: 0, explanation: "Hypervisor بيدير عدة VMs على سيرفر واحد." },
        { type: "mcq", question: "Which type of virtualization allows multiple VMs on one physical server?", options: ["Server Virtualization", "Storage Virtualization", "Network Virtualization", "Desktop Virtualization"], answer: 0, explanation: "Server Virtualization = عدة VMs على سيرفر واحد." },
        { type: "mcq", question: "Which of the following is an example of network virtualization?", options: ["Hypervisor", "VLANs", "SAN", "NAS"], answer: 1, explanation: "VLANs مثال على Network Virtualization." },
        { type: "mcq", question: "What is a hypervisor also known as?", options: ["Virtual Machine Controller (VMC)", "Virtual Machine Monitor (VMM)", "Virtual Machine Allocator (VMA)", "Virtual Machine Scheduler (VMS)"], answer: 1, explanation: "Hypervisor معروف أيضًا بـ Virtual Machine Monitor (VMM)." },
        { type: "mcq", question: "Which type of hypervisor runs directly on the host hardware?", options: ["Type 1 (Bare Metal)", "Type 2 (Hosted)", "Hybrid Hypervisor", "Embedded Hypervisor"], answer: 0, explanation: "Type 1 بيشتغل مباشرة على الهاردوير." },
        { type: "mcq", question: "Which of the following is an example of a Type 2 hypervisor?", options: ["VMware ESXi", "Microsoft Hyper-V", "VMware Workstation", "KVM"], answer: 2, explanation: "VMware Workstation بيشتغل فوق نظام تشغيل = Type 2." },
        { type: "mcq", question: "Virtualization allows:", options: ["Only one OS per server", "Multiple operating systems on one physical machine", "Only one VM per server", "Servers without hardware"], answer: 1, explanation: "Virtualization بتسمح بتشغيل أنظمة تشغيل متعددة على جهاز واحد." },
        { type: "mcq", question: "Which cloud service provider is the most mature and widely adopted?", options: ["Microsoft Azure", "Google Cloud Platform", "Amazon Web Services (AWS)", "IBM Cloud"], answer: 2, explanation: "AWS هو الأكثر نضجًا وانتشارًا." },
        { type: "mcq", question: "Which AWS service is used for relational databases?", options: ["DynamoDB", "RDS", "S3", "EC2"], answer: 1, explanation: "RDS لقواعد البيانات العلائقية في AWS." },
        { type: "mcq", question: "What is AWS SageMaker used for?", options: ["Image hosting", "Building and deploying machine learning models", "Managing DNS", "Database administration"], answer: 1, explanation: "SageMaker لبناء ونشر نماذج Machine Learning." },
        { type: "mcq", question: "Which AWS service provides compute resources in the cloud?", options: ["EC2", "S3", "VPC", "RDS"], answer: 0, explanation: "EC2 لموارد الحوسبة السحابية." },
        { type: "mcq", question: "Containers differ from virtual machines because containers:", options: ["Require a full guest OS", "Use hardware virtualization", "Share the host operating system kernel", "Cannot run applications"], answer: 2, explanation: "Containers بتشارك kernel نظام التشغيل المضيف بدل ما تحتاج OS كامل." },
        { type: "mcq", question: "Which cloud service model includes virtual machines and hypervisors?", options: ["SaaS", "PaaS", "IaaS", "FaaS"], answer: 2, explanation: "IaaS بيشمل VMs و Hypervisors." },

        // ========== Revision 1 - True/False ==========
        { type: "tf", question: "In a distributed system, nodes operate independently and can exchange information.", options: ["True", "False"], answer: 0, explanation: "صح، الـ Nodes مستقلة وبتتواصل عبر الشبكة." },
        { type: "tf", question: "A distributed system requires a global clock for synchronization.", options: ["True", "False"], answer: 1, explanation: "غلط، مفيش global clock في الأنظمة الموزعة." },
        { type: "tf", question: "An overlay network is a physical network.", options: ["True", "False"], answer: 1, explanation: "غلط، Overlay network شبكة افتراضية أو منطقية." },
        { type: "tf", question: "Peer-to-peer systems are an example of an overlay network.", options: ["True", "False"], answer: 0, explanation: "صح، P2P مثال على Overlay network." },
        { type: "tf", question: "In an open group, any node is allowed to join and communicate.", options: ["True", "False"], answer: 0, explanation: "صح، Open group أي Node يقدر ينضم." },
        { type: "tf", question: "All nodes in a distributed system share the same clock.", options: ["True", "False"], answer: 1, explanation: "غلط، كل Node عنده ساعته." },
        { type: "tf", question: "Users usually know where data is stored in a distributed system.", options: ["True", "False"], answer: 1, explanation: "غلط، المستخدمين عادة مش بيعرفوا أين البيانات مخزنة." },
        { type: "tf", question: "Distributed systems improve system reliability.", options: ["True", "False"], answer: 0, explanation: "صح، بتحسن الموثوقية عبر fault tolerance." },
        { type: "tf", question: "Partial failures are common in distributed systems.", options: ["True", "False"], answer: 0, explanation: "صح، بعض الأجزاء ممكن تفشل والباقي يكمل." },
        { type: "tf", question: "A distributed system appears as multiple systems to users.", options: ["True", "False"], answer: 1, explanation: "غلط، بيظهر كنظام واحد للمستخدم." },
        { type: "tf", question: "Network communication in distributed systems is always instantaneous.", options: ["True", "False"], answer: 1, explanation: "غلط، فيه تأخير (latency) في الشبكة." },
        { type: "tf", question: "Distribution transparency hides system complexity from users.", options: ["True", "False"], answer: 0, explanation: "صح، بتخفي التعقيدات." },
        { type: "tf", question: "If one node fails, the entire distributed system must fail.", options: ["True", "False"], answer: 1, explanation: "غلط، باقي الـ Nodes بتكمل شغل." },
        { type: "tf", question: "Distributed systems can scale to support millions of users.", options: ["True", "False"], answer: 0, explanation: "صح، قابلة للتوسع لملايين المستخدمين." },
        { type: "tf", question: "Public cloud is shared by multiple users.", options: ["True", "False"], answer: 0, explanation: "صح، Public cloud مشترك." },
        { type: "tf", question: "Private cloud is used by a single organization.", options: ["True", "False"], answer: 0, explanation: "صح، لمنظمة واحدة فقط." },
        { type: "tf", question: "Hybrid cloud combines public and private clouds.", options: ["True", "False"], answer: 0, explanation: "صح، بيجمع بين الاتنين." },
        { type: "tf", question: "On-demand service allows users to create computing resources automatically anytime.", options: ["True", "False"], answer: 0, explanation: "صح، On-demand = موارد تلقائيًا في أي وقت." },
        { type: "tf", question: "Broad network access allows services to be accessed from any device over the internet.", options: ["True", "False"], answer: 0, explanation: "صح، الوصول من أي جهاز." },
        { type: "tf", question: "Resource pooling means resources are dedicated to a single user.", options: ["True", "False"], answer: 1, explanation: "غلط، Resource pooling = الموارد مشتركة بين عدة مستخدمين." },
        { type: "tf", question: "Rapid elasticity allows resources to scale up or down dynamically.", options: ["True", "False"], answer: 0, explanation: "صح، التوسع والانكماش ديناميكيًا." },
        { type: "tf", question: "Measured service means usage is monitored and billed based on consumption.", options: ["True", "False"], answer: 0, explanation: "صح، المراقبة والمحاسبة حسب الاستهلاك." },
        { type: "tf", question: "Virtualization allows only one virtual machine to run on a physical server.", options: ["True", "False"], answer: 1, explanation: "غلط، عدة VMs ممكن تشتغل على سيرفر واحد." },
        { type: "tf", question: "A hypervisor manages multiple virtual machines on one physical server.", options: ["True", "False"], answer: 0, explanation: "صح، Hypervisor بيدير عدة VMs." },
        { type: "tf", question: "Server virtualization allows multiple VMs to run on one physical server.", options: ["True", "False"], answer: 0, explanation: "صح." },
        { type: "tf", question: "Storage virtualization combines many storage devices into one logical storage pool.", options: ["True", "False"], answer: 0, explanation: "صح، بيجمع أجهزة تخزين في pool واحد." },
        { type: "tf", question: "Network virtualization creates virtual networks on top of physical networks.", options: ["True", "False"], answer: 0, explanation: "صح، شبكات افتراضية فوق الفيزيائية." },
        { type: "tf", question: "Type 2 hypervisors run directly on the physical hardware.", options: ["True", "False"], answer: 1, explanation: "غلط، Type 2 بيشتغل فوق نظام تشغيل." },
        { type: "tf", question: "Docker containers use OS-level virtualization.", options: ["True", "False"], answer: 0, explanation: "صح، Containers بتستخدم OS-level virtualization." },
        { type: "tf", question: "AWS SageMaker is used for image and video analysis.", options: ["True", "False"], answer: 1, explanation: "غلط، SageMaker لبناء ونشر ML models." },

        // ========== Revision 2 - MCQ ==========
        { type: "mcq", question: "Why is partition tolerance considered mandatory in distributed systems?", options: ["Because consistency is optional", "Because networks never fail", "Because network failures are inevitable", "Because availability is always guaranteed"], answer: 2, explanation: "Partition tolerance ضروري لأن أعطال الشبكة حتمية." },
        { type: "mcq", question: "Which system prioritizes availability over consistency?", options: ["Banking system", "ATM network", "Social media platform", "Airline reservation"], answer: 2, explanation: "السوشيال ميديا بتفضل Availability على Consistency." },
        { type: "mcq", question: "A system always returns a response, but sometimes the data is outdated. This describes:", options: ["Consistency", "Availability", "Partition tolerance", "Security"], answer: 1, explanation: "النظام بيرد دايمًا حتى لو البيانات قديمة = Availability." },
        { type: "mcq", question: "Which statement about CAP is correct?", options: ["A system can guarantee all three (C, A, P)", "Partition tolerance is optional", "A system must choose between consistency and availability", "Availability is always sacrificed"], answer: 2, explanation: "في CAP لازم تختار بين Consistency و Availability." },
        { type: "mcq", question: "Which is a key characteristic of scalability in cloud computing?", options: ["System cannot grow", "System handles increased workload", "Limits performance", "Requires manual intervention"], answer: 1, explanation: "Scalability = التعامل مع حمل عمل متزايد." },
        { type: "mcq", question: "Which is a type of scalability in cloud computing?", options: ["Vertical and horizontal scaling", "Manual and automatic scaling", "Static and dynamic scaling", "Internal and external scaling"], answer: 0, explanation: "Vertical scaling (توسيع الجهاز) و Horizontal scaling (إضافة أجهزة)." },
        { type: "mcq", question: "What is the primary function of a load balancer?", options: ["Increase load on single server", "Distribute incoming network traffic across multiple servers", "Reduce performance", "Limit users"], answer: 1, explanation: "Load balancer بيوزع traffic على عدة سيرفرات." },
        { type: "mcq", question: "Which type of scaling involves increasing CPU, RAM, or storage in a single machine?", options: ["Horizontal Scaling", "Auto-scaling", "Vertical Scaling", "Load Balancing"], answer: 2, explanation: "Vertical Scaling = زيادة موارد الجهاز الواحد." },
        { type: "mcq", question: "Which type of scaling adds more machines to distribute workload?", options: ["Vertical Scaling", "Horizontal Scaling", "Elastic Scaling", "Manual Scaling"], answer: 1, explanation: "Horizontal Scaling = إضافة أجهزة جديدة." },
        { type: "mcq", question: "Which is a limitation of Vertical Scaling?", options: ["Complex management", "Unlimited scalability", "Physical hardware limits", "Requires load balancing"], answer: 2, explanation: "Vertical Scaling محدود بقدرات الهاردوير." },
        { type: "mcq", question: "Elasticity refers to:", options: ["Long-term system design", "Manual expansion", "Real-time automatic adjustment of resources", "Increasing server power"], answer: 2, explanation: "Elasticity = تعديل تلقائي للموارد في الوقت الفعلي." },
        { type: "mcq", question: "What is the main purpose of Auto-Scaling?", options: ["Monitor logs", "Replace load balancer", "Automatically adjust resources based on demand", "Increase storage permanently"], answer: 2, explanation: "Auto-Scaling بيعدل الموارد تلقائيًا حسب الطلب." },
        { type: "mcq", question: "Which is NOT a step in Auto-Scaling?", options: ["Monitor metrics", "Apply rules", "Encrypt data", "Adjust resources"], answer: 2, explanation: "تشفير البيانات مش من خطوات Auto-Scaling." },
        { type: "mcq", question: "Load Balancing is used to:", options: ["Increase CPU speed", "Distribute traffic across multiple servers", "Store data securely", "Reduce RAM usage"], answer: 1, explanation: "Load Balancing لتوزيع traffic." },
        { type: "mcq", question: "What happens if traffic is NOT properly distributed?", options: ["Improved performance", "System overload on one server", "Reduced latency", "Balanced workload"], answer: 1, explanation: "سيرفر واحد هيتحمل كل الحمل ويقع." },
        { type: "mcq", question: "Which cloud service provides load balancing?", options: ["AWS Elastic Load Balancer", "AWS S3", "AWS Lambda only", "AWS CloudWatch"], answer: 0, explanation: "AWS ELB للـ Load Balancing." },
        { type: "mcq", question: "What is the main goal of Scalability?", options: ["Reduce traffic", "Improve UI", "Grow system without breaking", "Increase storage only"], answer: 2, explanation: "Scalability = التوسع بدون ما النظام ينهار." },
        { type: "mcq", question: "Replication refers to:", options: ["Deleting duplicate data", "Compressing data", "Storing multiple copies of data across multiple servers", "Moving data to one server"], answer: 2, explanation: "Replication = تخزين نسخ متعددة من البيانات." },
        { type: "mcq", question: "Which is NOT a benefit of replication?", options: ["Reliability", "High availability", "Faster access", "Data conflicts"], answer: 3, explanation: "Data conflicts مشكلة وليست فائدة." },
        { type: "mcq", question: "Primary purpose of data replication?", options: ["Reduce storage costs", "Improve reliability, performance, and fault tolerance", "Eliminate backups", "Decrease bandwidth"], answer: 1, explanation: "Replication لتحسين الموثوقية والأداء وتحمل الأعطال." },
        { type: "mcq", question: "Which replication type ensures all replicas execute the same sequence of operations?", options: ["Primary-Backup", "Quorum-Based", "State Machine Replication", "Asynchronous"], answer: 2, explanation: "State Machine Replication بيضمن نفس تسلسل العمليات." },
        { type: "mcq", question: "A drawback of Eventual Consistency?", options: ["High latency for all", "Temporary inconsistencies until replicas converge", "Cannot handle partitions", "Manual conflict resolution"], answer: 1, explanation: "Eventual Consistency ممكن يكون فيه عدم تناسق مؤقت." },
        { type: "mcq", question: "Which consistency model guarantees all nodes see the most recent write immediately?", options: ["Eventual Consistency", "Strong Consistency", "Causal Consistency", "Monotonic Read"], answer: 1, explanation: "Strong Consistency = كل الـ Nodes بتشوف أحدث كتابة فورًا." },
        { type: "mcq", question: "Synchronous replication means:", options: ["Updates are delayed", "Updates happen randomly", "All replicas are updated immediately before acknowledging the write", "Only one replica is updated"], answer: 2, explanation: "Synchronous = كل النسخ بتتحدث قبل الرد على العملية." },
        { type: "mcq", question: "Asynchronous replication:", options: ["Guarantees strong consistency", "Is always slow", "May lead to temporary inconsistencies", "Requires all replicas to agree"], answer: 2, explanation: "Asynchronous ممكن يسبب عدم تناسق مؤقت." },
        { type: "mcq", question: "Primary goal of scheduling in cloud computing?", options: ["Increase costs", "Map jobs to VMs and allocate resources efficiently", "Reduce bandwidth", "Eliminate VMs"], answer: 1, explanation: "Scheduling لتوزيع المهام على VMs بكفاءة." },
        { type: "mcq", question: "Main characteristic of Round Robin scheduling?", options: ["Priority-based", "Cyclic order with fixed time quantum", "Longest first", "Random assignment"], answer: 1, explanation: "Round Robin = دوري بوقت ثابت لكل مهمة." },
        { type: "mcq", question: "Which scheduling algorithm executes tasks in arrival order?", options: ["SJF", "Priority Scheduling", "First-Come-First-Served (FCFS)", "Load Balancing"], answer: 2, explanation: "FCFS = الأول في الوصول الأول في التنفيذ." },
        { type: "mcq", question: "Which algorithm prioritizes tasks with shortest execution time?", options: ["Round Robin", "Priority Scheduling", "Shortest Job First (SJF)", "Deadline Constraint"], answer: 2, explanation: "SJF = الأقصر أولاً." },
        { type: "mcq", question: "Key advantage of Priority Scheduling?", options: ["Equal time for all", "Executes critical tasks first", "Minimizes context switching", "Energy efficiency"], answer: 1, explanation: "المهام الأهم بتتنفذ الأول." },
        { type: "mcq", question: "What problem can occur in Priority Scheduling if not managed?", options: ["Deadlock", "Priority Inversion", "Memory Leak", "Network Congestion"], answer: 1, explanation: "Priority Inversion ممكن يحصل لو مش مُدار بشكل صحيح." },
        { type: "mcq", question: "Primary goal of fault tolerance in cloud computing?", options: ["Increase costs", "Ensure continuous operation despite faults", "Reduce bandwidth", "Eliminate maintenance"], answer: 1, explanation: "Fault tolerance = استمرار العمل رغم الأعطال." },
        { type: "mcq", question: "Which represents the root cause of a system problem?", options: ["Error", "Failure", "Fault", "Crash"], answer: 2, explanation: "Fault هو السبب الجذري للمشكلة." },
        { type: "mcq", question: "What is an example of a hardware failure?", options: ["Kernel panic", "Power supply failure", "Invalid JSON input", "Firewall misconfiguration"], answer: 1, explanation: "Power supply failure مثال على hardware failure." },
        { type: "mcq", question: "Which failure classification focuses on how a system fails?", options: ["Operations-centric", "User-centric", "Component-centric", "Network-centric"], answer: 2, explanation: "Component-centric بتركز على كيف بيفشل المكون." },
        { type: "mcq", question: "Which is NOT a stage in the failure progression chain?", options: ["Fault", "Error", "Warning", "Failure"], answer: 2, explanation: "Warning مش مرحلة في سلسلة تطور الفشل." },
        { type: "mcq", question: "Primary purpose of reactive fault tolerance?", options: ["Predict failures", "Minimize impact after failures happen", "Eliminate all faults", "Reduce costs"], answer: 1, explanation: "Reactive = تقليل التأثير بعد حدوث الفشل." },
        { type: "mcq", question: "Which technique involves saving system state periodically?", options: ["Software rejuvenation", "Checkpointing", "Pre-emptive migration", "Load balancing"], answer: 1, explanation: "Checkpointing = حفظ حالة النظام دوريًا للاسترداد." },
        { type: "mcq", question: "Which metric measures average time between inherent system failures?", options: ["MTTR", "Fault detection time", "MTBF", "Recovery time"], answer: 2, explanation: "MTBF = Mean Time Between Failures." },
        { type: "mcq", question: "Goal of pre-emptive migration in proactive fault tolerance?", options: ["Wait until failure", "Move applications from unhealthy nodes before failures", "Reduce VMs", "Increase utilization"], answer: 1, explanation: "Pre-emptive migration = نقل التطبيقات قبل حدوث الفشل." },

        // ========== Revision 2 - True/False ==========
        { type: "tf", question: "Distributed systems can completely avoid failures.", options: ["True", "False"], answer: 1, explanation: "غلط، الأعطال لا يمكن تجنبها بالكامل." },
        { type: "tf", question: "In CAP theorem, CA systems are practical in real distributed environments.", options: ["True", "False"], answer: 1, explanation: "غلط، CA مش عملي أثناء partitions." },
        { type: "tf", question: "A system that guarantees the latest data at all times is consistent.", options: ["True", "False"], answer: 0, explanation: "صح، Consistency = بيانات محدثة دائمًا." },
        { type: "tf", question: "Availability means the system always returns correct data.", options: ["True", "False"], answer: 1, explanation: "غلط، Availability يعني النظام بيرد، مش إن البيانات صحيحة دايمًا." },
        { type: "tf", question: "Partial failure means the entire system stops working.", options: ["True", "False"], answer: 1, explanation: "غلط، بعض الأجزاء بتفشل والباقي بيكمل." },
        { type: "tf", question: "Scalability is the ability of a system to handle increased workload.", options: ["True", "False"], answer: 0, explanation: "صح، Scalability = التعامل مع حمل عمل أكبر." },
        { type: "tf", question: "Horizontal scaling means upgrading a single server.", options: ["True", "False"], answer: 1, explanation: "غلط، Horizontal = إضافة سيرفرات. Vertical = ترقية سيرفر واحد." },
        { type: "tf", question: "Auto-scaling works based on real-time metrics.", options: ["True", "False"], answer: 0, explanation: "صح، بيستخدم مقاييس لحظية." },
        { type: "tf", question: "Load balancing prevents one server from being overloaded.", options: ["True", "False"], answer: 0, explanation: "صح، بيمنع overload على سيرفر واحد." },
        { type: "tf", question: "Traffic in real systems is always predictable.", options: ["True", "False"], answer: 1, explanation: "غلط، traffic غير متوقع." },
        { type: "tf", question: "Load balancing is unnecessary when using multiple servers.", options: ["True", "False"], answer: 1, explanation: "غلط، load balancing مهم مع عدة سيرفرات." },
        { type: "tf", question: "Replication in distributed systems is primarily used to reduce storage costs.", options: ["True", "False"], answer: 1, explanation: "غلط، Replication لتحسين الموثوقية مش تقليل التكلفة." },
        { type: "tf", question: "In Primary-Backup replication, if the primary fails, the system stops functioning permanently.", options: ["True", "False"], answer: 1, explanation: "غلط، Backup بياخد مكان Primary." },
        { type: "tf", question: "Eventual Consistency guarantees that all replicas will eventually converge to the same state.", options: ["True", "False"], answer: 0, explanation: "صح، النسخ هتتطابق في النهاية." },
        { type: "tf", question: "Strong Consistency is ideal for systems where high availability is more important than up-to-date data.", options: ["True", "False"], answer: 1, explanation: "غلط، Strong Consistency بتأخر الاستجابة علشان تضمن البيانات محدثة." },
        { type: "tf", question: "Round Robin scheduling guarantees that no task monopolizes resources.", options: ["True", "False"], answer: 0, explanation: "صح، Round Robin بيدي كل مهمة وقت متساوي." },
        { type: "tf", question: "FCFS scheduling is optimal for minimizing waiting time for all tasks.", options: ["True", "False"], answer: 1, explanation: "غلط، FCFS ممكن يزود waiting time." },
        { type: "tf", question: "SJF scheduling always results in the lowest average waiting time.", options: ["True", "False"], answer: 0, explanation: "صح، SJF بيدي أقل average waiting time." },
        { type: "tf", question: "Priority Scheduling cannot be combined with FCFS for tasks of equal priority.", options: ["True", "False"], answer: 1, explanation: "غلط، ممكن يتجمعوا مع بعض." },
        { type: "tf", question: "Response time includes only the time a task spends executing, not waiting.", options: ["True", "False"], answer: 1, explanation: "غلط، Response time بيشمل وقت الانتظار كمان." },
        { type: "tf", question: "Reactive fault tolerance approaches are used to predict failures before they occur.", options: ["True", "False"], answer: 1, explanation: "غلط، Reactive بتتعامل مع الأعطال بعد حدوثها. Proactive هي اللي بتتنبأ." },
        { type: "tf", question: "Checkpointing prevents the loss of useful computation by saving system states periodically.", options: ["True", "False"], answer: 0, explanation: "صح، Checkpointing بيحفظ حالة النظام دوريًا." },
        { type: "tf", question: "Load balancing helps distribute CPU and memory usage across systems.", options: ["True", "False"], answer: 0, explanation: "صح، بيوزع الحمل على الأنظمة." },
    ],
  np: [
    // Tutorial 1
  ...
  c3: [
   ...
   es: [
        ...
        { type: "mcq", question: "Which is an example of an 8-bit microcontroller family mentioned in the slides?", options: ["ARM Cortex-M", "8051", "Intel Core i7", "NVIDIA GPU"], answer: 1, explanation: "8051 من أشهر عائلات المتحكمات الدقيقة 8-bit، أما ARM Cortex-M غالبًا 32-bit." },
        { type: "mcq", question: "Which factor is NOT listed as a criterion for choosing a microcontroller?", options: ["Power consumption", "Cost per unit", "Packaging", "Screen resolution"], answer: 3, explanation: "اختيار الميكروكنترولر يعتمد على الطاقة والتكلفة والحجم/التغليف، لكن Screen resolution تخص الشاشات مش الميكروكنترولر نفسه." },
        { type: "mcq", question: "The 8051 CPU can work on ____ bits of data at a time.", options: ["4", "8", "16", "32"], answer: 1, explanation: "8051 هو 8-bit microcontroller، يعني يتعامل مع 8 bits في المرة الواحدة." },
        { type: "mcq", question: "Which memory type is non-volatile and commonly used to store firmware?", options: ["SRAM", "Flash/ROM", "CPU registers only", "Cache only"], answer: 1, explanation: "Flash/ROM ذاكرة غير متطايرة، يعني البيانات لا تضيع بانقطاع الكهرباء، لذلك تخزن firmware." },
        { type: "mcq", question: "Which tool mainly converts C/C++ into machine code?", options: ["IDE", "Compiler", "Debugger", "Oscilloscope"], answer: 1, explanation: "Compiler هو الأداة التي تحول كود C/C++ إلى machine code يفهمه المعالج." },

        // ==================== AVR I/O PORT Programming ====================
        { type: "mcq", question: "In AVR GPIO, which register is read to get the actual logic level on a pin?", options: ["DDRx", "PORTx", "PINx", "OCRx"], answer: 2, explanation: "PINx يستخدم لقراءة الحالة الفعلية للـ pin، سواء HIGH أو LOW." },
        { type: "mcq", question: "If DDRB bit5 = 1, then PB5 is configured as:", options: ["INPUT", "ANALOG", "OUTPUT", "PWM-only"], answer: 2, explanation: "في AVR، لو bit في DDRx = 1 فهذا يعني أن الـ pin Output." },
        { type: "mcq", question: "When a pin is configured as INPUT (DDRx bit = 0), setting PORTx bit = 1 will:", options: ["Force the pin LOW", "Enable internal pull-up resistor", "Disable reading from pin", "Turn pin into OUTPUT"], answer: 1, explanation: "لما الـ pin يكون Input، كتابة 1 في PORTx تفعل الـ internal pull-up resistor." },
        { type: "mcq", question: "PINx register is used to:", options: ["Set pin direction", "Write output values", "Enable ADC", "Read the actual logic level on a pin"], answer: 3, explanation: "PINx مسؤول عن قراءة القيمة الفعلية الموجودة على الـ pin." },
        { type: "mcq", question: "When a pin is configured as OUTPUT (DDRx bit = 1), setting PORTx bit = 1 makes the pin:", options: ["LOW", "FLOATING", "INPUT", "HIGH"], answer: 3, explanation: "لو الـ pin Output و PORTx bit = 1، الخرج يكون HIGH." },
        { type: "mcq", question: "Which operation sets a bit (makes it 1)?", options: ["REG &= ~(1<<bit)", "REG ^= (1<<bit)", "REG |= (1<<bit)", "REG = ~(1<<bit)"], answer: 2, explanation: "عملية OR مع 1 تستخدم لضبط bit وجعلها 1 بدون التأثير على باقي الـ bits." },

        // ==================== Timer Programming ====================
        { type: "mcq", question: "The main disadvantage of using delay() is:", options: ["It increases accuracy", "It blocks CPU execution", "It reduces memory usage", "It enables interrupts"], answer: 1, explanation: "delay() توقف تنفيذ البرنامج وتجعل المعالج ينتظر، لذلك تعتبر blocking." },
        { type: "mcq", question: "A prescaler is used to:", options: ["Increase CPU speed", "Divide the timer clock", "Reset the timer counter", "Enable ADC"], answer: 1, explanation: "Prescaler يقسم تردد الساعة الداخل للـ Timer للحصول على timing مناسب." },
        { type: "mcq", question: "In CTC mode, the timer resets when:", options: ["It overflows", "It matches OCR1A", "It reaches 0", "It receives an external interrupt"], answer: 1, explanation: "في CTC mode، العداد يرجع للصفر عند الوصول إلى قيمة المقارنة OCR1A." },
        { type: "mcq", question: "The register that stores the current Timer1 count is:", options: ["OCR1A", "TCNT1", "TIMSK1", "TCCR1A"], answer: 1, explanation: "TCNT1 هو register الذي يحتوي على القيمة الحالية لعداد Timer1." },
        { type: "mcq", question: "The bit used to enable Timer1 Compare Match A interrupt is:", options: ["WGM12", "OCIE1A", "CS10", "OCF1A"], answer: 1, explanation: "OCIE1A هو bit تفعيل interrupt الخاصة بـ Compare Match A في Timer1." },
        { type: "mcq", question: "The formula to compute OCR1A for a desired period T (CTC) is:", options: ["OCR1A = (T * F_CPU / N) - 1", "OCR1A = (N * F_CPU / T) - 1", "OCR1A = T + N", "OCR1A = F_CPU - N"], answer: 0, explanation: "في CTC: عدد ticks = T * F_CPU / prescaler، ونطرح 1 لأن العد يبدأ من 0." },
        { type: "mcq", question: "volatile is needed for variables updated in ISR because:", options: ["It makes the variable constant", "It prevents compiler from assuming the value never changes", "It increases clock speed", "It changes prescaler"], answer: 1, explanation: "volatile يمنع الـ compiler من عمل optimization خاطئ لمتغير يتغير داخل ISR." },
        { type: "mcq", question: "If TIMSK1 enables the interrupt but sei() is NOT called, then:", options: ["ISR runs normally", "ISR never runs", "Timer stops counting", "OCR1A resets to zero"], answer: 1, explanation: "لازم sei() لتفعيل global interrupts، بدونها لن تعمل ISR حتى لو interrupt مفعلة." },
        { type: "mcq", question: "With 16 MHz clock and prescaler 64, the timer tick frequency becomes:", options: ["16 MHz", "1 MHz", "250 kHz", "64 kHz"], answer: 2, explanation: "Timer frequency = 16MHz / 64 = 250kHz." },
        { type: "mcq", question: "In Normal mode, an event occurs when:", options: ["TCNT1 == OCR1A", "Counter reaches MAX and returns to 0", "Prescaler becomes 0", "sei() is called"], answer: 1, explanation: "في Normal mode الحدث الأساسي هو Overflow عندما يصل العداد لأقصى قيمة ثم يعود للصفر." },
        { type: "mcq", question: "The register that holds the compare value for Timer1 channel A is:", options: ["TCNT1", "OCR1A", "TIFR1", "DDRB"], answer: 1, explanation: "OCR1A يحتوي على قيمة المقارنة الخاصة بـ Timer1 channel A." },
        { type: "mcq", question: "Polling means:", options: ["CPU waits by checking a flag repeatedly", "CPU sleeps permanently", "CPU runs ISR automatically", "Timer stops counting"], answer: 0, explanation: "Polling يعني أن المعالج يكرر فحص flag باستمرار حتى يحدث الحدث." },
        { type: "mcq", question: "An interrupt-based timer is better because:", options: ["It wastes CPU time", "It blocks the program", "It allows accurate timing while CPU does other tasks", "It disables peripherals"], answer: 2, explanation: "Interrupts تسمح للمعالج بعمل مهام أخرى، وعند حدوث الوقت المطلوب يتم تنفيذ ISR." },

        // ==================== External Interrupts ====================
        { type: "mcq", question: "Compared to polling, the biggest advantage of external interrupts is:", options: ["Higher RAM", "Immediate response without constant checking", "Higher clock speed", "More flash memory"], answer: 1, explanation: "External interrupt يستجيب فور حدوث الإشارة بدون أن يظل المعالج يفحص باستمرار." },
        { type: "mcq", question: "Pin polling mainly wastes CPU time because it:", options: ["Uses ADC", "Blocks the CPU in repeated reads/delays", "Disables timers", "Forces UART off"], answer: 1, explanation: "Polling يجعل CPU يضيع وقت في قراءة متكررة وانتظار بدل تنفيذ مهام أخرى." },
        { type: "mcq", question: "The register used to enable/disable specific external interrupts INTx is:", options: ["EIFR", "EIMSK", "EICRA", "SREG"], answer: 1, explanation: "EIMSK يستخدم لتفعيل أو تعطيل external interrupts مثل INT0 و INT1." },
        { type: "mcq", question: "For ATmega2560, INT0..INT3 sense control bits are in:", options: ["EICRA", "EICRB", "EIFR", "EIMSK"], answer: 0, explanation: "في ATmega2560، إعدادات sense control لـ INT0 إلى INT3 موجودة في EICRA." },
        { type: "mcq", question: "For ATmega2560, INT4..INT7 sense control bits are in:", options: ["EICRA", "EICRB", "EIFR", "TIMSK1"], answer: 1, explanation: "إعدادات sense control لـ INT4 إلى INT7 موجودة في EICRB." },
        { type: "mcq", question: "The meaning of ISCx1:ISCx0 = 10 is:", options: ["Low level", "Any change", "Falling edge", "Rising edge"], answer: 2, explanation: "القيمة 10 تعني Falling edge trigger." },
        { type: "mcq", question: "The meaning of ISCx1:ISCx0 = 11 is:", options: ["Low level", "Any change", "Falling edge", "Rising edge"], answer: 3, explanation: "القيمة 11 تعني Rising edge trigger." },
        { type: "mcq", question: "The meaning of ISCx1:ISCx0 = 00 is:", options: ["Low level", "Any change", "Falling edge", "Rising edge"], answer: 0, explanation: "القيمة 00 تعني Low level trigger." },
        { type: "mcq", question: "When using a pull-up resistor and a button connected to GND, the best trigger for press is:", options: ["Rising edge", "Falling edge", "Low level only", "Any change always"], answer: 1, explanation: "مع pull-up تكون الحالة HIGH، وعند الضغط تتصل بـ GND فتصبح LOW، إذن الحافة Falling edge." },
        { type: "mcq", question: "sei() does:", options: ["Enables only INT0", "Enables global interrupts", "Clears EIFR", "Resets Timer0"], answer: 1, explanation: "sei() تفعل global interrupts في AVR." },
        { type: "mcq", question: "cli() does:", options: ["Disables global interrupts", "Enables Timer interrupts", "Sets OCR0A", "Enables UART"], answer: 0, explanation: "cli() تعطل global interrupts." },
        { type: "mcq", question: "The best practice for ISRs is to:", options: ["Print a lot to Serial inside ISR", "Do long computations in ISR", "Keep ISR short and set a flag", "Call delay() for debounce"], answer: 2, explanation: "أفضل practice أن تكون ISR قصيرة جدًا وتقوم فقط بتغيير flag." },
        { type: "mcq", question: "In EIFR, to clear an external interrupt flag (INTFx), you typically:", options: ["Write 0 to it", "Read PINx", "Write 1 to it", "Call sei() twice"], answer: 2, explanation: "في AVR، كثير من flags يتم مسحها بكتابة 1 عليها." },
        { type: "mcq", question: "If INTx is configured as low-level, the interrupt request can:", options: ["Trigger repeatedly as long as the pin stays LOW", "Trigger only once ever", "Never trigger", "Only trigger on rising edge"], answer: 0, explanation: "Low-level interrupt قد يتكرر طالما الإشارة LOW." },
        { type: "mcq", question: "For a 1ms tick using Timer0 CTC, the interrupt that fires is typically:", options: ["INT4_vect", "TIMER0_COMPA_vect", "USART_RX_vect", "TIMER1_OVF_vect"], answer: 1, explanation: "في Timer0 CTC مع Compare Match A، الـ vector هو TIMER0_COMPA_vect." },

        // ==================== PWM Programming ====================
        { type: "mcq", question: "PWM stands for:", options: ["Pulse Width Modem", "Pulse Width Modulation", "Parallel Wave Memory", "Power Width Modulation"], answer: 1, explanation: "PWM اختصار Pulse Width Modulation." },
        { type: "mcq", question: "Duty cycle is:", options: ["Number of timers in the MCU", "Percentage of time the signal is HIGH in one period", "PWM frequency value", "The ADC resolution"], answer: 1, explanation: "Duty cycle هي نسبة زمن HIGH داخل period واحدة." },
        { type: "mcq", question: "A duty cycle of 0% means the output is:", options: ["Always HIGH", "Always LOW", "50% HIGH and 50% LOW", "Random"], answer: 1, explanation: "0% duty cycle يعني الإشارة LOW طوال الوقت." },
        { type: "mcq", question: "A duty cycle of 100% means the output is:", options: ["Always HIGH", "Always LOW", "Pulsing", "Disabled"], answer: 0, explanation: "100% duty cycle يعني الإشارة HIGH طوال الوقت." },
        { type: "mcq", question: "In Fast PWM, the timer counter counts:", options: ["TOP to 0 only", "0 to TOP repeatedly", "0 to TOP to 0 (up and down)", "Randomly"], answer: 1, explanation: "Fast PWM يعد من 0 إلى TOP ثم يعود ويكرر." },
        { type: "mcq", question: "In Phase Correct PWM, the timer counter counts:", options: ["0 to TOP only", "TOP to 0 only", "0 to TOP to 0 (up then down)", "0 to OCR only"], answer: 2, explanation: "Phase Correct يعد صعودًا من 0 إلى TOP ثم نزولًا إلى 0." },
        { type: "mcq", question: "Compared to Fast PWM with same TOP and prescaler, Phase Correct PWM frequency is usually:", options: ["Higher", "About the same", "About half", "Infinite"], answer: 2, explanation: "Phase Correct يأخذ وقتًا أطول لأنه يعد صعودًا ونزولًا، لذلك التردد غالبًا نصف Fast PWM تقريبًا." },
        { type: "mcq", question: "OCRnx register is mainly used to control:", options: ["Timer prescaler", "PWM duty cycle", "Global interrupts", "UART baud rate"], answer: 1, explanation: "OCRnx يحدد نقطة المقارنة، وبالتالي يتحكم في duty cycle." },
        { type: "mcq", question: "The main advantage of Phase Correct PWM is:", options: ["More interrupts", "More symmetric (center-aligned) waveform", "Requires no timer registers", "Works only with ADC"], answer: 1, explanation: "Phase Correct يعطي waveform أكثر تماثلًا حول المنتصف." },
        { type: "mcq", question: "If you increase the prescaler value, PWM frequency will:", options: ["Increase", "Decrease", "Stay the same", "Become random"], answer: 1, explanation: "زيادة prescaler تقلل clock الداخل للـ timer وبالتالي يقل PWM frequency." },
        { type: "mcq", question: "To change duty cycle in real time, you should update:", options: ["TCCRnB only", "OCRnx", "DDRx", "ICRn only"], answer: 1, explanation: "تغيير duty cycle يتم عن طريق تحديث OCRnx." },

        // ==================== ADC / DAC / Sensors ====================
        { type: "mcq", question: "An analog signal is best described as:", options: ["Only 0 or 1", "A continuous range of values", "A fixed integer value", "Always a square wave"], answer: 1, explanation: "الإشارة analog تكون مستمرة ولها مدى من القيم وليس فقط 0 و 1." },
        { type: "mcq", question: "The main purpose of an ADC is to:", options: ["Convert digital to analog", "Convert analog voltage to a digital number", "Increase PWM frequency", "Filter noise automatically"], answer: 1, explanation: "ADC يحول الجهد analog إلى رقم digital يمكن للمعالج التعامل معه." },
        { type: "mcq", question: "The ADC input voltage range is usually:", options: ["0 V to Vref", "-Vref to +Vref", "0 V to infinity", "Any voltage is accepted"], answer: 0, explanation: "غالبًا ADC يقيس من 0 إلى Vref." },
        { type: "mcq", question: "Vref is defined as:", options: ["The timer prescaler", "The ADC reference voltage used for conversion", "The UART baud rate", "The PWM duty cycle"], answer: 1, explanation: "Vref هو الجهد المرجعي الذي يستخدمه ADC لتحديد مدى القياس." },
        { type: "mcq", question: "A 10-bit ADC produces output values in the range:", options: ["0 – 255", "0 – 511", "0 – 1023", "0 – 2047"], answer: 2, explanation: "10-bit يعني 2^10 = 1024 مستوى، من 0 إلى 1023." },
        { type: "mcq", question: "The number of quantization levels for a 10-bit ADC is:", options: ["10", "100", "1024", "4096"], answer: 2, explanation: "عدد المستويات = 2^10 = 1024." },
        { type: "mcq", question: "The LSB (step size) for a 10-bit ADC with Vref = 5 V is approximately:", options: ["Vref × 1024", "Vref / 1024", "1024 / Vref", "Vref / 256"], answer: 1, explanation: "Step size تقريبًا = Vref / 1024." },
        { type: "mcq", question: "If Vref = 5 V and ADC reading = 1023, the input voltage is closest to:", options: ["0 V", "2.5 V", "5 V", "10 V"], answer: 2, explanation: "قراءة 1023 قريبة جدًا من أعلى قيمة وهي Vref = 5V." },
        { type: "mcq", question: "Sampling in an ADC context means:", options: ["Smoothing the output using PWM", "Taking a snapshot of the input voltage at a moment", "Increasing resolution", "Reducing timer speed"], answer: 1, explanation: "Sampling يعني أخذ عينة أو لقطة من الجهد في لحظة معينة." },
        { type: "mcq", question: "Noise in ADC readings is best reduced by:", options: ["Using delay inside an ISR", "Averaging multiple samples", "Disabling the ADC", "Setting duty cycle to 100%"], answer: 1, explanation: "تجميع و averaging عدة قراءات يقلل تأثير noise." },
        { type: "mcq", question: "The AVR register that selects the ADC channel and reference voltage is:", options: ["ADCSRA", "ADMUX", "OCR0A", "TCCR0A"], answer: 1, explanation: "ADMUX يحدد قناة ADC وكذلك reference voltage." },
        { type: "mcq", question: "The AVR register that enables the ADC and starts a conversion is:", options: ["ADCSRA", "ADMUX", "DDRB", "EIFR"], answer: 0, explanation: "ADCSRA يحتوي على bits لتفعيل ADC وبدء conversion." },
        { type: "mcq", question: "Setting the ADC prescaler correctly is important because it:", options: ["Sets LED brightness", "Sets ADC clock speed for accurate conversion", "Enables SPI", "Changes Vref"], answer: 1, explanation: "ADC يحتاج clock مناسب للحصول على conversion دقيقة." },
        { type: "mcq", question: "A real DAC outputs:", options: ["A digital number", "An analog voltage or current based on a digital input", "Only PWM signals", "Only interrupts"], answer: 1, explanation: "DAC يحول رقم digital إلى جهد أو تيار analog." },
        { type: "mcq", question: "If a microcontroller has no built-in DAC, the most common software alternative is:", options: ["UART output", "PWM + low-pass RC filter", "External interrupt", "EEPROM"], answer: 1, explanation: "PWM مع low-pass filter يمكن أن يعطي خرج analog تقريبي." },
        { type: "mcq", question: "PWM can act like a DAC because:", options: ["PWM is always analog", "The average output voltage depends on duty cycle", "PWM increases ADC accuracy", "PWM changes Vref"], answer: 1, explanation: "متوسط جهد PWM يعتمد على duty cycle، لذلك يمكن استخدامه كـ DAC تقريبي." },
        { type: "mcq", question: "The approximate average output voltage of a PWM signal is:", options: ["Vout = Vref / duty", "Vout ≈ Duty × Vcc", "Vout = Vcc + duty", "Vout = duty / Vcc"], answer: 1, explanation: "متوسط الخرج تقريبًا يساوي Duty × Vcc." },
        { type: "mcq", question: "An LDR is a:", options: ["Temperature sensor that outputs voltage directly", "Light-dependent resistor (resistance changes with light)", "Digital sensor only", "DAC device"], answer: 1, explanation: "LDR مقاومة تتغير قيمتها حسب شدة الضوء." },
        { type: "mcq", question: "To read an LDR with an ADC you usually connect the LDR through:", options: ["A voltage divider", "A UART cable", "A PWM output pin", "An interrupt pin"], answer: 0, explanation: "نستخدم voltage divider لتحويل تغير المقاومة إلى تغير في الجهد يمكن قياسه بالـ ADC." },
        { type: "mcq", question: "A floating analog input pin typically causes:", options: ["Constant stable ADC values", "Random or unsteady ADC values", "The ADC to stop working", "PWM to become faster"], answer: 1, explanation: "الـ floating pin لا يكون له جهد ثابت، لذلك يعطي قراءات عشوائية أو غير مستقرة." },

        // ==================== Communication Protocols ====================
        { type: "mcq", question: "UART stands for:", options: ["Universal Analog Receiver/Transmitter", "Universal Asynchronous Receiver/Transmitter", "Unified Asynchronous Register Transfer", "Universal Array Receiver/Transmitter"], answer: 1, explanation: "UART اختصار Universal Asynchronous Receiver/Transmitter." },
        { type: "mcq", question: "UART is classified as:", options: ["Synchronous serial", "Asynchronous serial", "Parallel bus", "Optical link"], answer: 1, explanation: "UART اتصال serial غير متزامن، لا يحتاج clock line مشتركة." },
        { type: "mcq", question: "The minimum wires required for basic UART communication are:", options: ["SDA, SCL", "MOSI, MISO, SCK", "TX, RX, GND", "CS, SCK, GND"], answer: 2, explanation: "UART الأساسي يحتاج TX و RX و GND." },
        { type: "mcq", question: "A UART frame usually starts with a:", options: ["Stop bit", "Start bit", "Parity bit", "Clock pulse"], answer: 1, explanation: "UART frame يبدأ بـ start bit لإعلام المستقبل ببداية البيانات." },
        { type: "mcq", question: "For UART to work correctly, both communicating sides must agree on:", options: ["An address", "Baud rate and frame format", "Chip select polarity", "Pull-up resistor values"], answer: 1, explanation: "UART يحتاج نفس baud rate ونفس frame format بين الطرفين." },
        { type: "mcq", question: "In UART on the AVR, the UDRE flag in UCSR0A indicates:", options: ["Receive complete", "Transmit data register empty / ready", "Start condition detected", "SPI transfer complete"], answer: 1, explanation: "UDRE يعني أن transmit buffer جاهز لاستقبال byte جديدة للإرسال." },
        { type: "mcq", question: "SPI is classified as:", options: ["Asynchronous", "Synchronous", "Optical", "Wireless"], answer: 1, explanation: "SPI بروتوكول synchronous لأنه يستخدم clock line." },
        { type: "mcq", question: "In SPI, the clock line is called:", options: ["SDA", "SCL", "SCK", "RX"], answer: 2, explanation: "خط الساعة في SPI يسمى SCK." },
        { type: "mcq", question: "MOSI in SPI stands for:", options: ["Master Out Slave In", "Master Over Serial Interface", "Memory Output Serial Input", "Mode Of Serial Input"], answer: 0, explanation: "MOSI يعني Master Out Slave In، أي البيانات من Master إلى Slave." },
        { type: "mcq", question: "SPI is typically faster than UART because it:", options: ["Has no clock", "Uses a shared clock and hardware shift register", "Uses start/stop bits", "Uses device addresses"], answer: 1, explanation: "SPI يستخدم clock مشترك و hardware shift register مما يجعله أسرع غالبًا." },
        { type: "mcq", question: "SPI full-duplex means:", options: ["Only send", "Only receive", "Send and receive simultaneously", "Send once per second"], answer: 2, explanation: "Full-duplex يعني إرسال واستقبال في نفس الوقت." },
        { type: "mcq", question: "When using SPI with multiple slaves, typically each slave needs:", options: ["Its own CS/SS line", "Its own SDA line", "Its own RX/TX pair", "Its own clock generator"], answer: 0, explanation: "كل Slave في SPI غالبًا يحتاج CS/SS خاص به لاختياره." },
        { type: "mcq", question: "SPI mode compatibility between master and slave depends on:", options: ["Pull-up resistor values", "CPOL and CPHA settings", "UART parity", "I2C device address"], answer: 1, explanation: "SPI mode يتحدد من CPOL و CPHA، ولازم الطرفين يتفقوا عليهم." },
        { type: "mcq", question: "I2C uses how many main signal lines excluding power and GND?", options: ["1", "2", "3", "4"], answer: 1, explanation: "I2C يستخدم خطين رئيسيين: SDA و SCL." },
        { type: "mcq", question: "The two I2C signal lines are called:", options: ["TX and RX", "MOSI and MISO", "SDA and SCL", "CS and SCK"], answer: 2, explanation: "خطوط I2C هي SDA للبيانات و SCL للساعة." },
        { type: "mcq", question: "I2C supports multiple devices on the same bus by using:", options: ["Separate CS lines", "Device addresses", "UART parity bits", "PWM duty cycle"], answer: 1, explanation: "I2C يستخدم addresses لتمييز الأجهزة على نفس الـ bus." },
        { type: "mcq", question: "I2C requires pull-up resistors because its bus lines are:", options: ["Push-pull output", "Open-drain / open-collector", "Optical", "Differential"], answer: 1, explanation: "I2C open-drain/open-collector لذلك يحتاج pull-up resistors." },
        { type: "mcq", question: "Every I2C transaction begins with a:", options: ["START condition", "Parity bit", "CS low pulse", "Stop bit"], answer: 0, explanation: "أي عملية I2C تبدأ بـ START condition." },
        { type: "mcq", question: "After sending an I2C slave address, the addressed device responds with:", options: ["UDRE", "ACK or NACK", "CPHA", "A PWM pulse"], answer: 1, explanation: "بعد إرسال address، الجهاز يرد بـ ACK لو استقبل أو NACK لو لم يستجب." },
        { type: "mcq", question: "The best protocol choice for high-speed display or flash memory access is usually:", options: ["UART", "SPI", "I2C", "ADC"], answer: 1, explanation: "SPI غالبًا الأفضل للسرعات العالية مثل displays و flash memories." },

        // ==================== RTOS Basics ====================
        { type: "mcq", question: "An RTOS is mainly used in embedded systems to provide:", options: ["Higher clock speed", "Predictable timing and task scheduling", "More flash memory", "Better ADC accuracy"], answer: 1, explanation: "RTOS يوفر timing predictable وجدولة للمهام." },
        { type: "mcq", question: "Real-time in the context of an RTOS means:", options: ["The system is always fast", "The system meets timing deadlines predictably", "The system uses Wi-Fi", "The system never uses interrupts"], answer: 1, explanation: "Real-time يعني الالتزام بالمواعيد deadlines بشكل متوقع، وليس مجرد السرعة." },
        { type: "mcq", question: "In a hard real-time system, missing a deadline is:", options: ["Always acceptable", "A system failure", "Only a small quality loss", "Fixed by increasing baud rate"], answer: 1, explanation: "في hard real-time، فشل deadline يعتبر فشل للنظام." },
        { type: "mcq", question: "A task in FreeRTOS is best described as:", options: ["A hardware pin", "An independent thread of execution with its own stack", "A UART register", "A clock signal"], answer: 1, explanation: "Task في FreeRTOS تشبه thread مستقلة لها stack خاص." },
        { type: "mcq", question: "Which of the following is NOT a typical RTOS task state?", options: ["Ready", "Running", "Blocked/Waiting", "Overclocked"], answer: 3, explanation: "Overclocked ليست حالة task في RTOS." },
        { type: "mcq", question: "In preemptive scheduling:", options: ["Tasks must manually yield the CPU", "Higher-priority tasks can interrupt lower-priority tasks", "Only one task can ever run", "The CPU runs without interrupts"], answer: 1, explanation: "في preemptive scheduling، المهمة ذات الأولوية الأعلى يمكن أن تقاطع الأقل." },
        { type: "mcq", question: "In cooperative scheduling, a task switch occurs only when:", options: ["A higher-priority task is created", "The current task yields or delays voluntarily", "An ADC conversion completes", "The timer prescaler overflows"], answer: 1, explanation: "في cooperative scheduling، المهمة الحالية يجب أن تتنازل أو تعمل delay طوعًا." },
        { type: "mcq", question: "A binary semaphore is best described as:", options: ["A counter from 0 to N", "A 0/1 signal used for synchronization or event notification", "A UART buffer", "A timer prescaler"], answer: 1, explanation: "Binary semaphore يكون 0 أو 1 ويستخدم للمزامنة أو الإشعارات." },
        { type: "mcq", question: "In FreeRTOS, the scheduler is started by calling:", options: ["xTaskCreate()", "vTaskStartScheduler()", "sei()", "cli()"], answer: 1, explanation: "vTaskStartScheduler() تبدأ scheduler في FreeRTOS." },
        { type: "mcq", question: "Zephyr RTOS is often described as:", options: ["Only a bootloader", "A more complete RTOS platform (kernel + drivers + networking)", "A UART library only", "A replacement for the C language"], answer: 1, explanation: "Zephyr منصة RTOS متكاملة تحتوي kernel و drivers و networking." },

        // ==================== True / False ====================
        { type: "tf", question: "A 10-bit ADC produces 1024 distinct digital output levels.", options: ["True", "False"], answer: 0, explanation: "صح، 10-bit يعني 2^10 = 1024 مستوى." },
        { type: "tf", question: "The ADMUX register on the AVR is used to enable the ADC and start a conversion.", options: ["True", "False"], answer: 1, explanation: "غلط، ADMUX يحدد channel و reference، أما ADCSRA يفعل ADC ويبدأ conversion." },
        { type: "tf", question: "PWM followed by a low-pass RC filter can approximate a DAC output.", options: ["True", "False"], answer: 0, explanation: "صح، PWM مع low-pass RC filter يعطي جهد analog تقريبي." },
        { type: "tf", question: "A floating ADC input pin always produces a stable and accurate reading.", options: ["True", "False"], answer: 1, explanation: "غلط، floating input يعطي قراءات عشوائية وغير ثابتة." },
        { type: "tf", question: "UART requires a shared clock line between transmitter and receiver.", options: ["True", "False"], answer: 1, explanation: "غلط، UART asynchronous ولا يحتاج clock line مشتركة." },
        { type: "tf", question: "In SPI, each additional slave device requires its own dedicated CS line.", options: ["True", "False"], answer: 0, explanation: "صح غالبًا، كل SPI slave يحتاج CS/SS منفصل لاختياره." },
        { type: "tf", question: "I2C SDA and SCL lines are open-drain, which is why pull-up resistors are required.", options: ["True", "False"], answer: 0, explanation: "صح، خطوط I2C open-drain/open-collector وتحتاج pull-up resistors." },
        { type: "tf", question: "In a soft real-time system, missing a timing deadline causes an immediate system failure.", options: ["True", "False"], answer: 1, explanation: "غلط، في soft real-time فوات deadline يقلل الجودة لكنه ليس فشلًا فوريًا غالبًا." },
        { type: "tf", question: "A mutex is used to protect a shared resource from concurrent access by multiple tasks.", options: ["True", "False"], answer: 0, explanation: "صح، Mutex يحمي shared resource من وصول أكثر من task في نفس الوقت." },
        { type: "tf", question: "FreeRTOS is a full operating system with a built-in networking stack comparable to Zephyr RTOS.", options: ["True", "False"], answer: 1, explanation: "غلط، FreeRTOS أخف وأبسط، بينما Zephyr منصة أشمل فيها drivers و networking بشكل أوسع." },
    ],
